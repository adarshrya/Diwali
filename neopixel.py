...
class Neopixel:
    ...
    def ShiftLeft(self,FirstIndex,LastIndex,Shift):
        num_of_pixels = FirstIndex + Shift 
        self.pixels[FirstIndex:LastIndex]=self.pixels[num_of_pixels:LastIndex]+self.pixels[FirstIndex:num_of_pixels]
        
    def ShiftRight(self,FirstIndex,LastIndex,Shift):
        num_of_pixels = LastIndex-Shift
        self.pixels[FirstIndex:LastIndex]=self.pixels[num_of_pixels:LastIndex]+self.pixels[FirstIndex:num_of_pixels]
